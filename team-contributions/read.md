<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:16a34a,100:22c55e&height=180&text=KhetMitra&fontSize=48&fontColor=ffffff&animation=fadeIn"/>
</p>

<p align="center">
  🌾 Smart Farming • 🤖 AI Powered • 🔌 IoT Integrated
</p>
...
<p align="center">
  <i>
    KhetMitra is an intelligent agriculture assistant that combines  
    <b>IoT sensors, AI models, and a scalable web system</b>  
    to help farmers make data-driven crop decisions.
  </i>
</p>
...
## 👥 Team Contributions
<p align="center"><i>Clear roles • Strong ownership • Smooth collaboration</i></p>
...
✨ Designed the **complete user experience** of KhetMitra  

- 🧩 Built responsive and farmer-friendly frontend  
- 🔗 Integrated backend APIs with frontend workflows  
- 🎯 Designed smooth user journeys & dashboards  
- 🧠 Managed overall feature integration  
...
### 🔌 Narayan Prasad  
#### IoT Hardware • Android

<div align="left">

⚙️ Connected **real-world farms to the digital system**

- 🔧 Assembled IoT hardware & soil sensors  
- 📡 Managed real-time sensor data collection  
- 📱 Developed Android-side IoT integration  
- 🔄 Ensured reliable data flow to backend  
...
- 🔗 End-to-end IoT → Backend → AI → Frontend pipeline  
- 📈 Scalable architecture for increasing users  
- 🛡️ Failure handling with modular components  
- 🌍 Designed for real-world agricultural deployment  

---

<p align="center">
  <b>🌟 Built with vision, ownership, and future-ready architecture 🌟</b>
</p>
